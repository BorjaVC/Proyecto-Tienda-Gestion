<?php 
      ...
      $consulta_datos = ("SELECT * FROM producto WHERE categoria_id = 4 ORDER BY producto_id ASC LIMIT $inicio,$registros");
      $consulta_total = ("SELECT COUNT(producto_id) FROM producto WHERE categoria_id = 4");
