    ...
    <div id="navbarBasicExample" class="navbar-menu">
        <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown">
                    <a href="index.php?vista=customer_new" class="navbar-item">Nuevo</a>
                    <a href="index.php?vista=customer_list" class="navbar-item">Lista</a>
                    <a href="index.php?vista=customer_search" class="navbar-item">Buscar</a>
                </div>
            </div>
            <div class="navbar-item has-dropdown is-hoverable">
        ...
        <div class="navbar-end">
            <div class="navbar-item">
                <div class="buttons">
                    <a href="index.php?vista=user_update&user_id_up=<?php echo $_SESSION['id'];?>" class="button is-primary is-rounded">Mi cuenta</a>
