<?php
    ...
    //Verificar integridad de los datos (cliente) 
    ...
    $actualizar_cliente=$actualizar_cliente->prepare("UPDATE usuario SET firstname=:nombre,lastname=:apellido,username=:usuario,password=:clave,email=:email WHERE id=:id");
