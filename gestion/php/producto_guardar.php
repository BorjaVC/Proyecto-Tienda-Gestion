<?php
    ...
    /*if(verificar_datos("[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,150}",$descripcion)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO producto(producto_nombre, categoria_id, producto_talla, producto_color, producto_precio, producto_cantidad, producto_descripcion, producto_foto, usuario_id) VALUES(:nombre,:categoria,:talla,:color,:precio,:cantidad,:descripcion,:foto,:usuario)");
