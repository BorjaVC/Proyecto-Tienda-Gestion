<?php
    ...
    if($check_categoria->rowCount()==1){
    	...
    	$check_articulos=conexion();
    	$check_articulos=$check_articulos->query("SELECT categoria_id FROM producto WHERE categoria_id='$category_id_del' LIMIT 1");

    	if($check_articulos->rowCount()<=0){
    		...
    		echo '
	            <div class="notification is-danger is-light">
	                <strong>¡Ocurrio un error inesperado!</strong><br>
	                No podemos eliminar la categoría ya que tiene articulos asociados
	            </div>
	        ';
    	}
