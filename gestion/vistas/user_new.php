		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Segundo Apellido</label>
				  	<input class="input" type="text" name="usuario_apellido_2" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" maxlength="40" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Rol</label>
				  	<input class="input" type="text" name="usuario_rol" placeholder="Administrador" disabled >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Teléfono</label>
				  	<input class="input" type="text" name="usuario_telefono" pattern="[0-9 ]{9,11}" maxlength="11" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Dirección</label>
				  	<input class="input" type="text" name="usuario_direccion"  maxlength="40" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
