	...
	<form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
        ...
        <div class="columns">
            <div class="column">
		    	<div class="control">
					<label>Talla</label>
				  	<input class="input" type="text" name="producto_talla" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required value="<?php echo $datos['producto_talla']; ?>" >
				</div>
		  	</div>
            <div class="column">
		    	<div class="control">
					<label>Color</label>
				  	<input class="input" type="text" name="producto_color" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="70" required value="<?php echo $datos['producto_color']; ?>" >
				</div>
		  	</div>
        </div>
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Cantidad</label>
				  	<input class="input" type="text" name="producto_cantidad" pattern="[0-9]{1,25}" maxlength="25" required value="<?php echo $datos['producto_cantidad']; ?>" >
				</div>
		  	</div>		  	
		</div>
        <div class="columns">
